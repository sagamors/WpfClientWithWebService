...
{
    public abstract class ValidationViewModelBase<TView> : ViewModelBase<TView>, IValidationViewModel, INotifyPropertyChanged,  INotifyDataErrorInfo where TView : IView
    {
  
        public ValidationViewModelBase([NotNull]IKernel kernel, [NotNull] TView view) : base(kernel, view)
        {
